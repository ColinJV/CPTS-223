...
Discussion of using a LINKED LIST for the data structure involved with storing the commands and descriptions
...
Discussion of using an ARRAY for the data structure involved with storing the user profiles
